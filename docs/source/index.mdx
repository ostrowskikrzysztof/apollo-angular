...
Follow the [quick start tutorial](get-started/) to start fetching data in minutes. For a longer end-to-end example that includes pagination, local state management, and building a graph API, check out the [official Apollo tutorial](https://www.apollographql.com/docs/angular/tutorial/introduction/).
